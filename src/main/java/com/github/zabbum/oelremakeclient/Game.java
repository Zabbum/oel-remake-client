...
import com.github.zabbum.oelrlib.requests.BuyOilfieldRequest;
import com.github.zabbum.oelrlib.requests.OelRequest;
...
public class Game {
    ...
    public void start() throws InterruptedException {
        ...
        if (shouldCreateNewGame) {
            baseGame = requestsCreator.createGame(playerName, playerAmount);
        } else {
            String gameId = promptGameId();
            baseGame = requestsCreator.joinGame(playerName, gameId);
        }
    ...
    private class Display {
        ...
        public MenuResponse buyIndustryMenu(
            ...
            oelRequest = BuyIndustryRequest.builder()
                    ...
                    .playerId(playerId)
                    .industryClassName(industries.getFirst().getClass().getName())
